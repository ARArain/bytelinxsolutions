...
<head>
    ...
    <link rel="icon" href="<?php echo general_asset('assets/images/favicon/7.png');?>" type="image/x-icon">
    ...
    <!-- bootstrap css -->
    <link id="rtl-link" rel="stylesheet" type="text/css" href="<?php echo general_asset('assets/css/vendors/bootstrap.css');?>">

    <!-- wow css -->
    <link rel="stylesheet" href="<?php echo general_asset('assets/css/animate.min.css');?>">

    <!-- Iconly css -->
    <link rel="stylesheet" type="text/css" href="<?php echo general_asset('assets/css/bulk-style.css');?>">
    <link rel="stylesheet" type="text/css" href="<?php echo general_asset('assets/css/vendors/animate.css');?>">

    <!-- Template css -->
    <link id="color-link" rel="stylesheet" type="text/css" href="<?php echo general_asset('assets/css/style.css');?>">
</head>
...
<body class="theme-color-7">
                            ...
                            <li class="right-nav-list">
                                <div class="dropdown theme-form-select">
                                    <button class="btn dropdown-toggle" type="button" id="select-language"
                                        ...
                                        <img src="<?php echo general_asset('assets/images/country/united-states.png');?>"
                                            class="img-fluid blur-up lazyload" alt="BytelinxSolutions">
                                        <span>English</span>
                                    </button>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="english">
                                                <img src="<?php echo general_asset('assets/images/country/united-kingdom.png');?>"
                                                    class="img-fluid blur-up lazyload" alt="BytelinxSolutions">
                                                <span>English</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="france">
                                                <img src="<?php echo general_asset('assets/images/country/germany.png');?>"
                                                    class="img-fluid blur-up lazyload" alt="BytelinxSolutions">
                                                <span>Germany</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="chinese">
                                                <img src="<?php echo general_asset('assets/images/country/turkish.png');?>"
                                                    class="img-fluid blur-up lazyload" alt="BytelinxSolutions">
                                                <span>Turki</span>
                                            </a>
                                        </li>
                    ...
                    <div class="col-12">
                        <div class="navbar-top">
                            ...
                            <a href="index.html" class="web-logo nav-logo">
                                <img src="<?php echo general_asset('assets/images/logo/4.png');?>" class="img-fluid blur-up lazyload" alt="BytelinxSolutions">
                            </a>
                                                                ...
                                                                <div class="dropdown-column m-0">
                                                                    <div class="menu-img-banner">
                                                                        <a class="text-title"
                                                                            ...
                                                                            <img src="<?php echo general_asset('assets/images/mega-menu.png');?>"
                                                                                alt="banner">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="<?php echo general_asset('assets/images/vegetable/product/1.png');?>"
                                                                    class="blur-up lazyload" alt="BytelinxSolutions">
                                                            </a>
                                                    ...
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="<?php echo general_asset('assets/images/vegetable/product/2.png');?>"
                                                                    class="blur-up lazyload" alt="BytelinxSolutions">
                                                            </a>
                    ...
                    <div class="slider-animate">
                        <div>
                            <div class="home-contain rounded-0 p-0">
                                <img src="<?php echo general_asset('assets/images/home-bg.jpg');?>" class="img-fluid bg-img blur-up lazyload bg-top"
                                    alt="BytelinxSolutions">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-9">
                    <div class="feature-panel-slider no-arrow">
                        <div>
                            <a href="shop-left-sidebar.html" class="cate-box">
            ...
            <div class="row g-4">
                    ...
                    <div class="product-theme-box">
                        ...
                        <div class="img-box ratio_50">
                            <a href="product-digital.html">
                                <img src="<?php echo general_asset('assets/images/digital/theme/1.jpg');?>" class="bg-img">
                            </a>
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="product-theme-box">
                        <div class="img-box ratio_50">
                            <a href="product-digital.html">
                                <img src="<?php echo general_asset('assets/images/digital/theme/2.jpg');?>" class="bg-img">
                            </a>
                            <a href="#!" class="heart-icon">
                                <i data-feather="heart"></i>
                            </a>
                            ...
                            <div class="top-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="product-rating review-rating">
                                        ...
                                        <span class="content-color">(4.8)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="product-theme-box">
                        <div class="img-box ratio_50">
                            <a href="product-digital.html">
                                <img src="<?php echo general_asset('assets/images/digital/theme/3.jpg');?>" class="bg-img">
                            </a>
                            <a href="#!" class="heart-icon">
                                <i data-feather="heart"></i>
                            </a>
                            ...
                            <div class="top-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="product-rating review-rating">
                                        ...
                                        <span class="content-color">(4.7)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="product-theme-box">
                        <div class="img-box ratio_50">
                            <a href="product-digital.html">
                                <img src="<?php echo general_asset('assets/images/digital/theme/4.jpg');?>" class="bg-img">
                            </a>
                            <a href="#!" class="heart-icon">
                                <i data-feather="heart"></i>
                            </a>
                            ...
                            <div class="top-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="product-rating review-rating">
                                        ...
                                        <span class="content-color">(15)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="product-theme-box">
                        <div class="img-box ratio_50">
                            <a href="product-digital.html">
                                <img src="<?php echo general_asset('assets/images/digital/theme/5.jpg');?>" class="bg-img">
                            </a>
                            <a href="#!" class="heart-icon">
                                <i data-feather="heart"></i>
                            </a>
                        ...
                        <div class="content-box">
                            <div class="top-content">
                                <a href="product-digital.html">
                                    <h5>Fuzzy - Ecommerce PWA Mobile HTML Template</h5>
                                </a>
                                <div class="d-flex align-items-center justify-content-between">
                                    <h6>by <a href="#!"> PixelStrap</a> in <a href="#!">PWA</a></h6>
                                    <div class="product-rating review-rating">
                                        <ul class="rating">
                                            <li>
                                                <i data-feather="star" class="fill"></i>
                                        ...
                                        <span class="content-color">(4.2)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="product-theme-box">
                        <div class="img-box ratio_50">
                            <a href="product-digital.html">
                                <img src="<?php echo general_asset('assets/images/digital/theme/6.jpg');?>" class="bg-img">
                            </a>
                            <a href="#!" class="heart-icon">
                                <i data-feather="heart"></i>
                            </a>
                        ...
                        <div class="content-box">
                            <div class="top-content">
                                <a href="product-digital.html">
                                    <h5>Design Factory - Architecture Figma Template</h5>
                                </a>
                                <div class="d-flex align-items-center justify-content-between">
                                    <h6>by <a href="#!"> Design Art</a> in <a href="#!">Figma</a></h6>
                                    <div class="product-rating review-rating">
                                        <ul class="rating">
                                            <li>
                                                <i data-feather="star" class="fill"></i>
                                        ...
                                        <span class="content-color">(10)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="product-theme-box">
                        <div class="img-box ratio_50">
                            <a href="product-digital.html">
                                <img src="<?php echo general_asset('assets/images/digital/theme/7.jpg');?>" class="bg-img">
                            </a>
                            <a href="#!" class="heart-icon">
                                <i data-feather="heart"></i>
                            </a>
                        ...
                        <div class="content-box">
                            <div class="top-content">
                                <a href="product-digital.html">
                                    <h5>Goapp - Upcoming Video Announcements</h5>
                                </a>
                                <div class="d-flex align-items-center justify-content-between">
                                    <h6>by <a href="#!"> PixelStrap</a> in <a href="#!">Admin</a></h6>
                                    <div class="product-rating review-rating">
                                        <ul class="rating">
                                            <li>
                                                <i data-feather="star" class="fill"></i>
                                        ...
                                        <span class="content-color">(3.7)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-content">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="product-theme-box">
                        <div class="img-box ratio_50">
                            <a href="product-digital.html">
                                <img src="<?php echo general_asset('assets/images/digital/theme/8.jpg');?>" class="bg-img">
                            </a>
                            <a href="#!" class="heart-icon">
                                <i data-feather="heart"></i>
                            </a>
                        ...
                        <div class="content-box">
                            <div class="top-content">
                                <a href="product-digital.html">
                                    <h5>Megabot - AI Writer & Copywriting Landing Page HTML Template</h5>
                                </a>
                                <div class="d-flex align-items-center justify-content-between">
                                    <h6>by <a href="#!"> PixelStrap</a> in <a href="#!">HTML</a></h6>
                                    <div class="product-rating review-rating">
                                        <ul class="rating">
                                            <li>
                                                <i data-feather="star" class="fill"></i>
                                        ...
                                        <span class="content-color">(35)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-content">
        ...
        <div class="container-fluid-lg">
            ...
            <div class="category-panel-slider no-arrow">
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/wordpress.svg');?>" alt="BytelinxSolutions">
                            <span>Wordpress</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/dot-net.jpg');?>" alt="BytelinxSolutions">
                            <span>.NET</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/shopify.svg');?>" alt="BytelinxSolutions">
                            <span>Shopify</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/ux-design.png');?>" alt="BytelinxSolutions">
                            <span>UI Kit</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/bootstrap.svg');?>" alt="BytelinxSolutions">
                            <span>Bootstrap</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/reactJs.svg');?>" alt="BytelinxSolutions">
                            <span>ReactJs</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/vueJs.svg');?>" alt="BytelinxSolutions">
                            <span>Vuejs</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/angular.svg');?>" alt="BytelinxSolutions">
                            <span>Angular</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/laravel.svg');?>" alt="BytelinxSolutions">
                            <span>Laravel</span>
                        </a>
                    </div>
                </div>
                <div>
                    <div>
                        <a href="shop-left-sidebar.html" class="cate-box">
                            <img src="<?php echo general_asset('assets/images/brand/django.svg');?>" alt="BytelinxSolutions">
                            <span>Django</span>
                        </a>
                    </div>
                </div>
    ...
    <section class="featured-sec section-b-space">
        <div class="container-fluid-lg">
            <div class="row g-3">
                <div class="col-xxl-3 col-lg-4">
                    <div class="feature-title">
                        <div>
                            ...
                            <p>Every week, our staff personally hand-pick some of the best new website themes from our
                                collection.</p>
                            <button onclick="location.href = 'product-digital.html';"
                                class="btn theme-bg-color text-light mt-sm-4 mt-3">View all <i
                            ...
                            <div class="product-theme-box">
                                ...
                                <div class="content-box">
                                    <div class="top-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6>by <a href="shop-left-sidebar.html"> Hooli</a> in <a
                                                    href="shop-left-sidebar.html">Music</a></h6>
                                            <div class="product-rating review-rating">
                                                <ul class="rating">
                                                    <li>
                                                        <i data-feather="star" class="fill"></i>
                            ...
                            <div class="product-theme-box">
                                ...
                                <div class="content-box">
                                    <div class="top-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6>by <a href="shop-left-sidebar.html"> Criphin</a> in <a
                                                    href="shop-left-sidebar.html">Graphics</a></h6>
                                            <div class="product-rating review-rating">
                                                <ul class="rating">
                                                    <li>
                                                        <i data-feather="star" class="fill"></i>
                            ...
                            <div class="product-theme-box">
                                ...
                                <div class="content-box">
                                    <div class="top-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6>by <a href="shop-left-sidebar.html"> Maxico</a> in <a
                                                    href="shop-left-sidebar.html">HTML</a></h6>
                                            <div class="product-rating review-rating">
                                                <ul class="rating">
                                                    <li>
                                                        <i data-feather="star" class="fill"></i>
                            ...
                            <div class="product-theme-box">
                                ...
                                <div class="content-box">
                                    <div class="top-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6>by <a href="shop-left-sidebar.html"> pictureEdit</a> in <a
                                                    href="shop-left-sidebar.html">Photo Effect</a></h6>
                                            <div class="product-rating review-rating">
                                                <ul class="rating">
                                                    <li>
                                                        <i data-feather="star" class="fill"></i>
                            ...
                            <div class="product-theme-box">
                                ...
                                <div class="content-box">
                                    <div class="top-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6>by <a href="shop-left-sidebar.html"> PixelStrap</a> in <a
                                                    href="shop-left-sidebar.html">PWA</a></h6>
                                            <div class="product-rating review-rating">
                                                <ul class="rating">
                                                    <li>
                                                        <i data-feather="star" class="fill"></i>
                            ...
                            <div class="product-theme-box">
                                ...
                                <div class="content-box">
                                    <div class="top-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6>by <a href="shop-left-sidebar.html"> Design Art</a> in <a
                                                    href="shop-left-sidebar.html">Figma</a></h6>
                                            <div class="product-rating review-rating">
                                                <ul class="rating">
                                                    <li>
                                                        <i data-feather="star" class="fill"></i>
                            ...
                            <div class="product-theme-box">
                                ...
                                <div class="content-box">
                                    <div class="top-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6>by <a href="shop-left-sidebar.html"> PixelStrap</a> in <a
                                                    href="shop-left-sidebar.html">Admin</a></h6>
                                            <div class="product-rating review-rating">
                                                <ul class="rating">
                                                    <li>
                                                        <i data-feather="star" class="fill"></i>
            ...
            <div class="slider-4-blog ratio_50 no-arrow">
                    ...
                    <div class="blog-box">
                        <div class="blog-box-image">
                            <a href="blog-detail.html" class="blog-image">
                                <img src="<?php echo general_asset('assets/images/digital/blog/1.jpg');?>" class="bg-img blur-up lazyload" alt="BytelinxSolutions">
                            </a>
                        </div>

                        <a href="blog-detail.html" class="blog-detail">
                            <h5>Discover Peach Fuzz, Pantone's Color of the Year for 2024</h5>
                        </a>
                        <p>Pantone has unveiled its Color of the Year for 2024: Peach Fuzz, a delightful shade with a
                            soothing and inviting aura. Peach Fuzz is a test…</p>
                ...
                <div>
                    <div class="blog-box">
                        <div class="blog-box-image">
                            <a href="blog-detail.html" class="blog-image">
                                <img src="<?php echo general_asset('assets/images/digital/blog/2.jpg');?>" class="bg-img blur-up lazyload" alt="BytelinxSolutions">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box">
                        <div class="blog-box-image">
                            <a href="blog-detail.html" class="blog-image">
                                <img src="<?php echo general_asset('assets/images/digital/blog/3.jpg');?>" class="bg-img blur-up lazyload" alt="BytelinxSolutions">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box">
                        <div class="blog-box-image">
                            <a href="blog-detail.html" class="blog-image">
                                <img src="<?php echo general_asset('assets/images/digital/blog/4.jpg');?>" class="bg-img blur-up lazyload" alt="BytelinxSolutions">
                            </a>
                        </div>
        ...
        <div class="container-fluid-lg">
            ...
            <div class="sub-footer sub-footer-lite py-3">
                ...
                <ul class="payment-box">
                    <li>
                        <img src="<?php echo general_asset('assets/images/icon/paymant/visa.png');?>" class="blur-up lazyload" alt="BytelinxSolutions">
                    </li>
                    <li>
                        <img src="<?php echo general_asset('assets/images/icon/paymant/discover.png');?>" alt="BytelinxSolutions" class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="<?php echo general_asset('assets/images/icon/paymant/american.png');?>" alt="BytelinxSolutions" class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="<?php echo general_asset('assets/images/icon/paymant/master-card.png');?>" alt="BytelinxSolutions" class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="<?php echo general_asset('assets/images/icon/paymant/giro-pay.png');?>" alt="BytelinxSolutions" class="blur-up lazyload">
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="<?php echo general_asset('assets/images/product/category/1.jpg');?>" class="img-fluid blur-up lazyload"
                                    alt="BytelinxSolutions">
                            </div>
                        </div>
    ...
    <div class="cookie-bar-box">
        <div class="cookie-box">
            <div class="cookie-image">
                <img src="<?php echo general_asset('assets/images/cookie-bar.png');?>" class="blur-up lazyload" alt="BytelinxSolutions">
                <h2>Cookies!</h2>
            </div>
                    ...
                    <div class="deal-offer-box">
                        <ul class="deal-offer-list">
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?php echo general_asset('assets/images/vegetable/product/10.png');?>" class="blur-up lazyload"
                                            alt="BytelinxSolutions">
                                    </a>
                            ...
                            <li class="list-2">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?php echo general_asset('assets/images/vegetable/product/11.png');?>" class="blur-up lazyload"
                                            alt="BytelinxSolutions">
                                    </a>
                            ...
                            <li class="list-3">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?php echo general_asset('assets/images/vegetable/product/12.png');?>" class="blur-up lazyload"
                                            alt="BytelinxSolutions">
                                    </a>
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?php echo general_asset('assets/images/vegetable/product/13.png');?>" class="blur-up lazyload"
                                            alt="BytelinxSolutions">
                                    </a>
    ...
    <!-- latest jquery-->
    <script src="<?php echo general_asset('assets/js/jquery-3.6.0.min.js');?>"></script>

    <!-- jquery ui-->
    <script src="<?php echo general_asset('assets/js/jquery-ui.min.js');?>"></script>

    <!-- Bootstrap js-->
    <script src="<?php echo general_asset('assets/js/bootstrap/bootstrap.bundle.min.js');?>"></script>
    <script src="<?php echo general_asset('assets/js/bootstrap/bootstrap-notify.min.js');?>"></script>
    <script src="<?php echo general_asset('assets/js/bootstrap/popper.min.js');?>"></script>

    <!-- feather icon js-->
    <script src="<?php echo general_asset('assets/js/feather/feather.min.js');?>"></script>
    <script src="<?php echo general_asset('assets/js/feather/feather-icon.js');?>"></script>

    <!-- Lazyload Js -->
    <script src="<?php echo general_asset('assets/js/lazysizes.min.js');?>"></script>

    <!-- Slick js-->
    <script src="<?php echo general_asset('assets/js/slick/slick.js');?>"></script>
    <script src="<?php echo general_asset('assets/js/slick/slick-animation.min.js');?>"></script>
    <script src="<?php echo general_asset('assets/js/slick/custom_slick.js');?>"></script>

    <!-- script js -->
    <script src="<?php echo general_asset('assets/js/script.js');?>"></script>

    <!-- theme setting js -->
    <script src="<?php echo general_asset('assets/js/theme-setting.js');?>"></script>
</body>
